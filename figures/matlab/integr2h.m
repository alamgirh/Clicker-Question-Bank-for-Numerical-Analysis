...
% and illustrate round-off errors for smallest h.
...
set( gca, 'XLim', [5e-6, 1e1], 'YLim', [1e-15, 5e1], 'XMinorGrid', 'off', 'YMinorGrid', 'off' )
xlabel('h'), ylabel('Error')
print -depsc 'integr2h.eps'
savefig('integr2h.fig')
